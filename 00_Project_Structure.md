...
│
├── docs/                        # 🗂️ 设计文档区
│   ├── 00_Project_Structure.md  # 项目目录结构规范
...
│   ├── 05_Voice_Interaction.md  # 语音交互文档 (ASR/TTS 逻辑)
│   ├── 06_Interaction_Display.md # 交互表现文档 (Live2D/气泡/动作分发)
│   ├── 07_API_Design.md         # API 设计文档 (VLM 接口通信与协议)
